...
**Имперский марш при старте:** при подаче питания buzzer проигрывает Imperial March (Star Wars) — 18 нот, ~5.5 сек, ноты из Gemini.
...
- `main.cpp` — Imperial March через `tone()` при старте
